        ...
        {this.props.volunteers.length ? (
                    ...
                    <td>
                      <div className='collapse' id={`collapse${volunteer.id}`}>
                        <div className='card card-body'>
                          ...
                          <object
                            data={`http://localhost:3001/uploads/${volunteer.cv}`}
                          ...
                          <p>
                            ...
                            {moment(volunteer.createdAt).format('LLL')}hs{' '}
                          </p>
                        </div>
                      </div>
                      <div key={volunteer.id}>
                        <Link
                          to={`/admin/voluntarios/${volunteer.id}`}
                          key={`detalles${volunteer.id}`}
          ...
          <div className='container-flud'>
            <h6 className='card-text'>
              En este momento no hay postulaciones pendientes{' '}
            </h6>{' '}
            <Link to='/admin' type='button' className='btn btn-danger border'>
              {' '}
