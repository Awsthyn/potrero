...
return(
     mostrar.length === 0 ? 
            <div>
                <h1 className="centerTitle">No hay estudiantes con faltas injsutificadas.</h1>
            </div>
            : (
                <div>
                   ...
                   mostrar.length > 0 ? mostrar.map( student => {
                       ...
                       return( 
                        <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Nombre: {student.firstName}</h5>
                                    <h6 class="card-title">Apellido: {student.lastName}</h6>
                                    <h5 class="card-subtitle mb-2 text-muted">Nombre tutor: {student.tutorFirstName}</h5>
                                    <h6 class="card-subtitle mb-2 text-muted">Apellido tutor: {student.tutorLastName}</h6>
                                    <a href="#" class="card-link">Mail del estudiante</a>
                                    <a href="#" class="card-link">Mail del tutor</a>
                                </div>
                            </div>
                            </div>
                            </li>
