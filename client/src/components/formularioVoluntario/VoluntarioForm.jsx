	...
	render() {
		...
		return (
			<div>
				...
				<p style={{fontSize:'1.3rem', margin: '0px'}} ><strong>Sumáte a nuestro equipo </strong></p>
				<span style={{fontWeight: 100, color: 'gray', fontSize: '15px'}} > Completá este formulario y nos pondremos en contacto con vos </span>
				</span>
