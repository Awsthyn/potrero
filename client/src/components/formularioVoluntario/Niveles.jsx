    ...
    if (redirect) {
		...
		return (
			<div>
                ...
                {
                    primario && !secundario ?  
                          primaria.map((n, i) => <div style={{margin:'10px'}} id={n} className={style.botonMateria}  onClick={(e) => handleOnClick(e,"Primaria")}>{n}</div>)
                          : null                  
                }
                {
                    secundario && !primario ? 
                          secundaria.map((n, i) => <div style={{margin:'10px'}} id={n} className={style.botonMateria}  onClick={(e) => handleOnClick(e,"Secundaria")}>{n}</div>) 
                          : null                     
                }
                </div>
                {
