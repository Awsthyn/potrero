...
const { Class, DataSheet, Role, Student, StudentSchedule, Subject, TypeOfDifficulty, User, UserSchedule, Volunteer, Weekday,TODXStudent,SubjectXVolunteer,SubjectXStudent,StudentXUser} = sequelize.models;
